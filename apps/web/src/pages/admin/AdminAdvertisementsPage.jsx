...
export function AdminAdvertisementsPage() {
  ...
  return (
    <main className="admin-content admin-resource-page">
      <div className="admin-page-head"><div><p>CAMPAIGNS · SCHEDULED</p><h1>Reklamalar</h1><span>Joylashuv, muddat va CTA’larni boshqaring.</span></div><button type="button" onClick={openCreate}><Plus size={15}/> Qo‘shish</button></div>
